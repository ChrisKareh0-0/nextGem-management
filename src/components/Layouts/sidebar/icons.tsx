...
export function ClientsIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.25 5.5A2.25 2.25 0 016.5 3.25h11a2.25 2.25 0 012.25 2.25v13a2.25 2.25 0 01-2.25 2.25h-11A2.25 2.25 0 014.25 18.5v-13zm2.25-.75a.75.75 0 00-.75.75v13c0 .414.336.75.75.75h11a.75.75 0 00.75-.75v-13a.75.75 0 00-.75-.75h-11z"
      />
      <path
        d="M9.75 8a1.75 1.75 0 113.5 0 1.75 1.75 0 01-3.5 0z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.036 12.5C8.536 11.958 9.232 11.75 10 11.75h4c.768 0 1.464.208 1.964.75.505.545.786 1.3.786 2.25a.75.75 0 01-.75.75h-8a.75.75 0 01-.75-.75c0-.95.281-1.705.786-2.25z"
      />
    </svg>
  );
}

export function ExpensesIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12.75 6a.75.75 0 00-1.5 0v.816a3.836 3.836 0 00-3.84 3.84.75.75 0 101.5.05A2.316 2.316 0 0112.75 9.66V18a.75.75 0 001.5 0V6z"
      />
    </svg>
  );
}
